...
- [Getting started with Tanzu Application Platform](getting-started.md)
  ...
  - [How-to guides for operators](getting-started/create-app-accelerator.md)
      ...
      - [Add testing and security scanning](getting-started/add-test-and-security.md)
  ...
  - [Concepts](getting-started/concepts.md)
      - [Concepts overview](getting-started/concepts.md)
...
- [Component documentation](components.md)
    ...
    - [Authentication and authorization](authn-authz/overview.md)
        - [Overview of authentication and authorization](authn-authz/overview.md)
        - [Setting up authentication for Tanzu Application Platform](authn-authz/integrating-identity.md)
            - [Overview](authn-authz/integrating-identity.md)
        ...
        - [Roles](authn-authz/role-descriptions.md)
    ...
    - [Application Accelerator](application-accelerator/about-application-accelerator.md)
        ...
        - [Specifications](application-accelerator/specs/options-spec.md)
    ...
    - [Supply Chain Security Tools for Tanzu – Store](scst-store/overview.md)
      - [Overview of Supply Chain Security Tools for Tanzu – Store](scst-store/overview.md)
    ...
    - [Tanzu Developer Tools for Visual Studio Code](vscode-extension/about.md)
      - [Overview](vscode-extension/about.md)
      - [Installing](vscode-extension/install.md)
      - [Getting started](vscode-extension/getting-started.md)
      - [Using](vscode-extension/using-the-extension.md)
